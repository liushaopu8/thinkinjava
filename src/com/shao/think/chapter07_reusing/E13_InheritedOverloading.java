//: chapter07_reusing/E13_InheritedOverloading.java
/****************** Exercise 13 *******************
 * Create a class with a method that is overloaded
 * three times. Inherit a new class, add a new
 * overloading of the method, and show that all
