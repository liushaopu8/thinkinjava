//: chapter07_reusing/E09_ConstructorOrder2.java
/****************** Exercise 9 *******************
 * Crate a class called Root and an instance of each
 * of three classes, Component1, Component2, and
 * Component3. Derive a class Stem from Root that
 * also contains an instance of each "component."
 * Default constructors for each class should print
